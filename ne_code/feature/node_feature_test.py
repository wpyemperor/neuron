# -*- coding: utf-8 -*-
"""
Created on Thu Jan 11 13:01:24 2018
...
if __name__ == '__main__':
    ...
    swc = SwcTree()
    swc.load('/home/wpy/pyzem/tests/data/c8076e_test.swc')
    swc._print()
    swc.save('/home/wpy/pyzem/tests/data/c8076e_test.swc')
    print(swc.node_count(False))
    #
    testn=swc.node_from_id(7)
    print(testn.children)
    print(testn.child_count())
    print(testn.branch_count())
    print(testn.bif_count())
    print(testn.tip_count())
    print(testn.stem_count())
    print(testn.pathdistance())
    print(testn.pathdistance_soma())
